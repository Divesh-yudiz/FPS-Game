...
class PointerLockControlsCannon extends THREE.EventDispatcher {
  constructor(camera, cannonBody, player) {
    super()
    ...
    this.velocityFactor = 60
    this.jumpVelocity = 300

    this.pitchObject = new THREE.Object3D()
    this.pitchObject.add(camera)
    this.pitchObject.y = 2000
  ...
  update(delta) {
    ...
    this.yawObject.position.y = this.cannonBody.position.y + 100
    this.yawObject.position.z = this.cannonBody.position.z

    this.player.position.x = this.yawObject.position.x
    this.player.position.y = this.yawObject.position.y - 0.5
    this.player.position.z = this.yawObject.position.z
    this.player.rotation.x = this.pitchObject.rotation.x
    this.player.rotation.y = this.yawObject.rotation.y
